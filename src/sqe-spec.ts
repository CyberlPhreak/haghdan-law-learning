...
export const sraSpecification = {
  ...
  currentLabel: 'SRA 2026/27 · قابل اعمال از ۱ سپتامبر ۲۰۲۶',
...
// September 2026 SQE1 specification, Overview of SQE1 assessments.
// These are this app's allocation targets, not a promise of exact SRA question counts.
// Accounts questions still require editorial classification into wills/property contexts.
export const firstSessionTargets: Record<SqeStage, Record<string, number>> = {
  FLK1: { 'flk1-business': 31, 'flk1-dispute': 31, 'flk1-services': 28 },
  FLK2: { 'flk2-wills': 27, 'flk2-accounts': 3, 'flk2-trusts': 30, 'flk2-land': 30 },
};
