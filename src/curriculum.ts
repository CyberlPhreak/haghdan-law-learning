...
export type Lesson = { id: string; pathwayId: string; title: string; englishTitle: string; duration: number; summary: string; sections: LessonSection[]; quiz: QuizQuestion[]; contentVersion?: string };
